...
(function($){
  ...
  var Renderer = function(elt){
    ...
    var that = {
      init:function(pSystem){
        ...
        if (document.referrer.match(/cuatro|cinco|seis/)){
          // if we got here by hitting the back button in one of the Camilo,
          // start with the Camilo section pre-selected
          that.switchSection('Camilo')
        }
      },
      resize:function(){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['Integrantes','Jhon','Cristian','Camilo']) >=0 ){
    ...
    var that = {
      ...
      update:function(){
        ...
        switch (_path){
          ...
          document.title = "Integrantes » " + _path
          break
        }
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"Integrantes":{color:"red", shape:"dot", alpha:1},

             Camilo:{color:CLR.branch, shape:"dot", alpha:1},
             seis:{color:CLR.demo, alpha:0, link:'/seis'},
             cinco:{color:CLR.demo, alpha:0, link:'/cinco'},
             cuatro:{color:CLR.demo, alpha:0, link:'/cuatro'},

             Cristian:{color:CLR.branch, shape:"dot", alpha:1},
             siete:{color:CLR.doc, alpha:0, link:'#siete'},
             ocho:{color:CLR.doc, alpha:0, link:'#ocho'},

             Jhon:{color:CLR.branch, shape:"dot", alpha:1},
             tres:{color:CLR.Jhon, alpha:0, link:'https://github.com/samizdatco/arbor'},
             "uno":{color:CLR.Jhon, alpha:0, link:'/js/dist/arbor-v0.92.zip'},
             "dos":{color:CLR.Jhon, alpha:0, link:'/js/dist/arbor-v0.92.tar.gz'}
            },
      edges:{
        "Integrantes":{
          Camilo:{length:.8},
